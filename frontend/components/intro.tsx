    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-100 w-100 rounded-full object-cover border-[0.25rem] border-black shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="/Yingjun Shen, AI engineer CV.pdf"
          download="Yingjun Shen, AI engineer CV.pdf"
        >
          Download CV{" "}
